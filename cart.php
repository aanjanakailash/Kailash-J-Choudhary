...
?>
 ...
 <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bn8.png) no-repeat scroll center center / cover ;">
											...
											<tr>
												...
												<td class="product-name"><a href="#"><?php echo $pname?></a>
													<ul  class="pro__prize">
														...
														<li><i class="fa fa-rupee"></i> <?php echo $price?></li>
													</ul>
												</td>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="buttons-cart--inner">
                                        ...
                                        <div class="bbuttons-cart checkout--btn">
