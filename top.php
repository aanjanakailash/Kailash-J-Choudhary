                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img src="images/logo/logo3.png" alt="logo images"></a>
                                </div>
                            </div>
                            <div class="col-md-7 col-lg-7 col-sm-5 col-xs-3">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                       <li class="drop"><a href="index.php"><i class="fa fa-home"></i>&nbsp;Home</a></li>
									   <li class="drop">
 ...
                                         </li>
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-4 col-xs-4">
                                <div class="header__right">
                                   ...
                                   <!--Start new account menu <a href="logout.php">Logout</a> <a href="my_order.php">My Order</a>-->
