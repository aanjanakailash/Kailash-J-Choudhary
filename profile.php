...
<!-- Start Bradcaump area -->
		...
		<!-- Start Contact Area -->
        <section class="htc__contact__area ptb--100 bg__white" style="background-image: url('images/bg3.png'); background-size: cover; background-position: center;">
            <div class="container">
                <div class="row">
					<div class="col-md-6">
		...
		function update_password(){
			...
			else if (new_password.length < 6 ) { // Set a minimum and maximum length
                jQuery('#new_password_error').html('Password must be between 6 long');
                is_error = 'yes';
            }
